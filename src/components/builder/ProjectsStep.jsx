...
function ProjectForm({ data, setData }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <div>
        <label className="block text-xs font-medium text-text-secondary mb-1">Project URL (optional)</label>
...
function ProjectPreview({ item }) {
  return (
    <div>
      ...
      {item.technologies && <div className="text-xs text-text-secondary mt-0.5">{item.technologies}</div>}
